...
ROOT = Path('/home/ubuntu/.openclaw/workspace/projects/leaf-db-exploration-2026-03-25')
OUT = ROOT / 'pilot-content-friction-results'
FIG = OUT / 'figures'
...
for i,content in enumerate(shortlist[:3], start=1):
    report.append(f"\n### User concentration check: {content['contents_name']}\n\n![](figures/fig5_concentration_{i}.svg)\n")
